...
test('Selecting a year from decade public triggers changeYear', function(){
    var target,
        triggered = 0;
...
test('Navigating forward/backward from month public triggers changeYear', function(){
    var target,
        triggered = 0;
...
test('Selecting a month from year public triggers changeMonth', function(){
    var target,
        triggered = 0;
...
test('Navigating forward/backward from month public triggers changeMonth', function(){
    var target,
        triggered = 0;
...
test('Clear button: triggers change and changeDate events', function(){
    ...
    this.input.focus();
    ok(this.picker.find('.datepicker-days').is(':visible'), 'Days public visible');
...
test('Changing public mode triggers changeViewMode', function () {
  var viewMode = -1,
    triggered = 0;
