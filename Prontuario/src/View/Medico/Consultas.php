    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="Consultas.php"><i class="fa fa-book"></i> <span>Consultas</span></a></li>
                <li><a href="MedAtend.php"><i class="fa fa-fw fa-stethoscope"></i> <span>Atendimentos</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_object($con->query)) {
                                    echo "<tr>
                                          ...
                                          <td>$row->hora</td>
                                          <td align=\"center\">
                                        <a href=\"MedAtend.php?id=  $row->id \" <button type=\"button\" class=\"btn btn-success\">
                                            Atender
                                        </button>
                                        </a>
                                        ...
                                        <a href= \"../../Controller/controller.php?id=$row->id&enviar=Deletar\"<button type=\"button\" class=\"btn btn-danger\">
                                            Deletar
                                        </button>
                                        </a>
                                    </td>
                                ...
                                <div class="modal-dialog" style="margin-top: 15%">
                                    <div class="modal-content">
                                        <div class="modal-header" align="center">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span></button>
                                            <h2 class="modal-title">Agendamento deletado com sucesso.</h2>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                                ...
                                <div class="modal-dialog" style="margin-top: 15%">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title">Erro ao Deletar: <?php print($_GET['erro']); ?> </h4>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
