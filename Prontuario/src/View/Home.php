<?php include("../../src/Model/seguranca.php");
protegePagina();
?>
            ...
            <div class="row" style="margin-top: 8%; margin-left: 10%">
                <div class="col-lg-5 col-xs-8">
                    ...
                    <div class="small-box bg-light-blue">
                        ...
                        <a href="Agendamento.php" class="small-box-footer"> Agendar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-5 col-xs-6" style="margin-left: 4%">
                    ...
                    <div class="small-box bg-light-blue">
                        ...
                        <a href="Medico.php" class="small-box-footer">Cadastrar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-5 col-xs-6" style="margin-top: 4%">
                    ...
                    <div class="small-box bg-light-blue">
                        ...
                        <a href="Paciente.php" class="small-box-footer">Cadastrar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
