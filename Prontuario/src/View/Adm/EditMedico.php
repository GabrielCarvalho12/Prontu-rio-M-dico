                        ...
                        <div class="row" align="left">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input readonly="true" value="<?php echo $linha->crm; ?>" class="form-control" name="crm"
                                           placeholder="CRM">
                                </div>
                            </div>
                            <!-- /.col -->
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $linha->nome; ?>" class="form-control" name="nome" placeholder="Nome">
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>CPF:</label>
                                    <div class="input-group">
                                        <input value="<?php echo $linha->cpf; ?>" name="cpf" type="text" class="form-control" data-inputmask='"mask":"999.999.999-99"' data-mask>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input value="<?php echo $linha->data_nascimento; ?>" name="data_nascimento"  class="form-control pull-right" id="datepicker">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $linha->trabalho; ?>" name="trabalho" class="form-control" id="Trabalho" placeholder="Email">
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" style="margin-top: 15%">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h2 class="modal-title">Cadastrado medico editado com sucesso.</h2>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                                ...
                                <div class="modal-dialog" style="margin-top: 15%">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title">Erro ao editar: <?php print($_GET['erro']); ?> </h4>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
