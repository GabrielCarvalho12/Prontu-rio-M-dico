                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_object($con->query)) {
                                    echo "<tr>
                                          ...
                                          <td>$row->hora</td>
                                          <td align=\"center\">
                                        <a href=\"Atendimento.php?id= $row->id \" <button type=\"button\" class=\"btn btn-success\">
                                            Atender
                                        </button>
                                        </a>

                                        <a href=\"EditAgendamento.php?id= $row->id \" <button type=\"button\" class=\"btn btn-warning\">
                                            Editar
                                        </button>
                                        </a>
                                ...
                                <div class=\"modal-dialog\">
                                    <div class=\"modal-content\">
                                        ...
                                        <div class=\"modal-footer\">
                                            <a href=\"../../Controller/controller.php?id=$row->id &enviar=DelAgenda\"
                                ...
                                <div class="modal-dialog" style="margin-top: 15%">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span></button>
                                            <h3 class="modal-title">Agendamento editado com sucesso.</h3>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
