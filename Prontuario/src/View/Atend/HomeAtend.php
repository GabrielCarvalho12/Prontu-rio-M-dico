            ...
            <div class="row" style="margin-top: 17%; margin-left: 10%">
                <div class="col-lg-5 col-xs-8">
                    ...
                    <div class="small-box bg-light-blue">
                        ...
                        <a href="AgendAtend.php" class="small-box-footer"> Agendar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-5 col-xs-6" style="float: left%">
                    ...
                    <div class="small-box bg-light-blue">
                        ...
                        <a href="AtendPaciente.php" class="small-box-footer">Cadastrar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            </div>
