    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="ExibeAgendAtend.php"><i class="fa fa-book"></i> <span>Agendamentos</span></a></li>
                <li class="treeview">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    while ($row = mysqli_fetch_object($con->query)) {
                                        ...
                                        <a href=\"EditAgendAtend.php?id= $row->id \" <button type=\"button\" class=\"btn btn-warning\">
                                            Editar
                                        </button>
                                        </a>
                                ...
                                <div class=\"modal-dialog\">
                                    <div class=\"modal-content\">
                                        ...
                                        <div class=\"modal-footer\">
                                            <a href=\"../../Controller/controller.php?id=$row->id &enviar=DelAgendaAtend\"
