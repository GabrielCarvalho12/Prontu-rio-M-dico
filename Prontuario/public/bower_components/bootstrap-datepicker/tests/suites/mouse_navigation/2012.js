...
test('Navigating to/from year public', function(){
    var target;
...
test('Navigating to/from decade public', function(){
    var target;
...
test('Navigating prev/next in year public', function(){
    var target;
...
test('Navigating prev/next in decade public', function(){
    var target;
