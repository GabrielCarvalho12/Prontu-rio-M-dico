...
test('Startview: year public (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':not(:visible)'), 'Days public hidden');
    ok(picker.find('.datepicker-months').is(':visible'), 'Months public visible');
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years public hidden');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades public hidden');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries public hidden');
});

test('Startview: year public (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: decade public (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':not(:visible)'), 'Days public hidden');
    ok(picker.find('.datepicker-months').is(':not(:visible)'), 'Months public hidden');
    ok(picker.find('.datepicker-years').is(':visible'), 'Years public visible');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades public hidden');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries public hidden');
});

test('Startview: decade public (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: century public (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    ok(picker.find('.datepicker-months').is(':not(:visible)'), 'Months public hidden');
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years public hidden');
    ok(picker.find('.datepicker-decades').is(':visible'), 'Decades public visible');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries public hidden');
});

test('Startview: century public (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: millennium public (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years public hidden');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades public hidden');
    ok(picker.find('.datepicker-centuries').is(':visible'), 'Centuries public visible');
});

test('Startview: millennium public (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Today Button: today button not default', function(){
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':visible'), 'Days public visible');
...
test('Today Button: moves to days public', function(){
...
test('Startview: year public visible after date pick', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                startView: 2,
...
test('Week Days: Week days default visibility (or enabled)', function(){
    ...
    input.focus();
    ok(picker.find('.dow').length > 0, 'Week days added to public');
});
test('Week Days: Week days visibility when disabled', function(){
    ...
    input.focus();
    ok(picker.find('.dow').length === 0, 'Week days not added to public');
});
