...
test('by day (right/left arrows)', function(){
    ...
    // public and focus updated on keyboard navigation, not selected
...
test('by month, v1 (shift + left/right arrows)', function(){
    ...
    // public and focus updated on keyboard navigation w/ graceful date ends, not selected
...
test('by year, from leap day', function(){
    ...
    // public and focus updated on keyboard navigation w/ graceful month ends, not selected
...
test('Selection (enter)', function(){
    ...
    // public and selection updated, focus cleared
    datesEqual(this.dp.viewDate, UTCDate(2012, 2, 30));
...
test('Selection + hide (enter)', function(){
    ...
    // public and selection updatedfocus cleared
    datesEqual(this.dp.viewDate, UTCDate(2012, 2, 30));
    datesEqual(this.dp.dates.get(-1), UTCDate(2012, 2, 30));
    equal(this.dp.focusDate, null);
    // Month not changed
